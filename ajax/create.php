...
/** START PROCESS */
$_command        = 'sudo python '.PYTHON_PATH.'gpusher_fast.py '.$_file_full_path.' '.$_monitor_file .' '.$_data_file.' '.$_time_monitor.' '.$_trace_file.' '.$id_task.' '.$_print_type.' 2>'.$_debug_file.' > /dev/null & echo $!';
