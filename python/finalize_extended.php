...
function finalize_print($tid, $status){
	...
	*/
	...
	$end_macro =  $file['print_type'] == 'subtractive' ? 'end_file_of_batch_subtractive' : 'end_print_additive';
	...
	//EXEC END MACRO
	shell_exec('sudo python /var/www/fabui/application/plugins/pcbmill/python/gmacro_extended.py '.$end_macro.' '.$_macro_end_print_trace.' '.$_macro_end_print_response.' > /dev/null &');
